...
public class JiraListener
    ...
    public void onTestFailure(ITestResult result) {
        ...
        if (islogIssue) {
            ...
            JiraServiceProvider JiraServiceProvider = new JiraServiceProvider(GlobalConstants.JIRA_SITE_URL, GlobalConstants.JIRA_USER_NAME, GlobalConstants.JIRA_API_KEY, GlobalConstants.JIRA_PROJECT_KEY);
